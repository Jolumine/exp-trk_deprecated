...
from ...const import Money_Logo, routines, types, Information_Logo

import json
import os


class Passive_Expense_Window(QDialog):
    def __init__(self, active, parent=None):
        ...
        self.name.setToolTip("Enter the name of the expense source")
        ...
        self.amount.setToolTip("Enter the amount which will be automatically")
        ...
        self.type_label.setText("Type of expense: ")
        ...
        self.setWindowTitle("Passive Expense Configuration")
    ...
    def add(self):
        ...
        if name in parsed["passive expense"]: 
            msg = QMessageBox()
            ...
            if rep == QMessageBox.Cancel: 
                ...
                with open(self.active_path, "w") as file: 
                    parsed["passive expense"][name] = {"Name": name, "Amount": amount, "Repeated" : repeat,"Type": selected_type, "Description": description}
